...
MOCK_USERS_DB = {"id" :"1" , "name": "alper" , "role": "admin"}

async def servicesreturner():
    """
    settings deki servisler kısmını döndürür (dependency injection için servisler kısmını direk ilgili fonksiyona vermedim)
    """

    return envconfig_and_settings.Settings.SERVICES
